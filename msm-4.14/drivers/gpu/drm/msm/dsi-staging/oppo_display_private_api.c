...
#define FFL_LEVEL_START 19
#define FFL_LEVEL_END  1200
#define UPRARE  20
#define BACKUPRATE 30
#define KTDUPRATE 10
...
static void oppo_ffl_setting_thread(struct kthread_work *work)
{
	...
	for(index = FFL_LEVEL_START;index < FFL_LEVEL_END;index = index + ffluprate ) {
...
/*shutdownflag node - /sys/kernel/oppo_display/shutdownflag-----begin*/
/*
...
/*shutdownflag node - /sys/kernel/oppo_display/shutdownflag-----end*/
