...
int set_oppo_display_vendor(const char * display_name) {
	...
	if (!strcmp(display_name,"dsi_oppo19021_ili9881_auo_vid_display")) {
		oppo_display_vendor = OPPO_ILI9881_AUO_DISPLAY_HDPLUS_VIDEO_PANEL;
		register_device_proc("lcd", "ILI9881_BRANDON", "auo2048");
	} else if (!strcmp(display_name,"dsi_oppo19021_ili9881_tm_vid_display")) {
		oppo_display_vendor = OPPO_ILI9881_TM_DISPLAY_HDPLUS_VIDEO_PANEL;
		register_device_proc("lcd", "ILI9881_BRANDON", "tm2048");
	} else if (!strcmp(display_name,"dsi_oppo19021_ili9881_inx_vid_display")) {
		oppo_display_vendor = OPPO_ILI9881_INX_DISPLAY_HDPLUS_VIDEO_PANEL;
		register_device_proc("lcd", "ILI9881_BRANDON", "inx2048");
	} else if (!strcmp(display_name,"dsi_oppo19021_nt36525b_boe_vid_display")) {
		oppo_display_vendor = OPPO_NT36525B_BOE_DISPLAY_HDPLUS_VIDEO_PANEL;
		register_device_proc("lcd", "NT36525B_BRANDON", "boe2048");
	} else if (!strcmp(display_name,"dsi_oppo19021_nt36525b_hlt_vid_display")) {
		oppo_display_vendor = OPPO_NT36525B_HLT_DISPLAY_HDPLUS_VIDEO_PANEL;
		register_device_proc("lcd", "NT36525B_BRANDON", "hlt2048");
	} else {
