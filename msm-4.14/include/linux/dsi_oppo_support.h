...
enum oppo_display_support_list {
	OPPO_ILI9881_AUO_DISPLAY_HDPLUS_VIDEO_PANEL = 0,
	OPPO_ILI9881_TM_DISPLAY_HDPLUS_VIDEO_PANEL = 1,
	OPPO_ILI9881_INX_DISPLAY_HDPLUS_VIDEO_PANEL = 2,
	OPPO_NT36525B_BOE_DISPLAY_HDPLUS_VIDEO_PANEL = 3,
	OPPO_NT36525B_HLT_DISPLAY_HDPLUS_VIDEO_PANEL = 4,
	OPPO_DISPLAY_UNKNOW,
};
